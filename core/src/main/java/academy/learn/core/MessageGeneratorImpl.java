...
public class MessageGeneratorImpl implements MessageGenerator {
    ...
    public String getResultMessage() {
        ...
        if(game.isGameWon()) return "You guesed it! The number was " + game.getNumber();
        ...
        else if(game.getRemainingGuesses() == game.getGuessCount()) return "What is your first guess?";
        else{
            String direction;
